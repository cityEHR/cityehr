...
<p:pipeline cityEHR:type="cityEHRapi" xmlns:p="http://www.orbeon.com/oxf/pipeline" xmlns:oxf="http://www.orbeon.com/oxf/processors"
    ...
    <p:processor name="oxf:xforms-submission">
        <p:input name="submission">
            <xf:submission serialization="none" method="get"
                action="{parameters[@type='database']/deployedDatabases/physicalCluster[@system='ehr'][1]/node[1]/@databaseURL}{parameters[@type='database']/deployedDatabases/physicalCluster[@system='ehr'][1]/node[1]/@btuLocation}/xmlstore/users/{parameters[@type='view']/userId}/credentials"
            />
        </p:input>
    ...
    <!-- Encrypt the password supplied as parameter to API call.
         Use the seed key set in the user crednetials to encrypt the password set as a parameter.
