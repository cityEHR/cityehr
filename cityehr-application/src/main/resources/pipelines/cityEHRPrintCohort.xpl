<!-- 
    *********************************************************************************************************
    cityEHR
    cityEHRPrintCohort.xpl
    
    Pipleline to transform input to HTML, XSL-FO and return PDF to browser
    Input is the patient-cohort-instance of patient-info elements
...
<p:pipeline xmlns:p="http://www.orbeon.com/oxf/pipeline"
    ...
    <!-- Input to pipeline is patient-cohort-instance -->
    <p:param name="instance" type="input"/>
    
    <!-- Produce HTML -->
    <!-- Input is the patient-cohort to be printed. -->
    <p:processor name="oxf:xslt">
        <p:input name="config" href="../xslt/PatientCohort2HTML.xsl"/>
        ...
        <p:input name="config" transform="oxf:xslt" href="#instance">
            <config xsl:version="2.0">
                <header>
                    ...
                    <value>attachement; filename=<xsl:value-of select="//patientSet/@externalId"/>.pdf</value>
                </header>
                <content-type>application/pdf</content-type>
