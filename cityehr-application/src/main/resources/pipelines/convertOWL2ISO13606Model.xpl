<!-- 
    *********************************************************************************************************
    cityEHR
    convertOWL2ISO13606Model.xpl
    
    Pipleline to convert OWL ontology to list of ISO-13606 nodes
...
<p:pipeline xmlns:p="http://www.orbeon.com/oxf/pipeline"
    ...
    <!-- Input to pipeline is single instance -->
    <p:param name="instance" type="input"/>

    <!-- Standard pipeline output -->
    <p:param name="data" type="output"/>

    <!-- Run XSLT to convert OWL/XML to an ISO-13606 XML model -->
    <p:processor name="oxf:xslt">
        <p:input name="config"
        href="../xslt/OWL2ISO13606.xsl"/>
