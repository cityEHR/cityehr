<!--
    cityEHR
    checkExpressions.xpl
    
    Pipeline calls XSLT processor to check expressions in an information model 
    The model is passed as an ontology 
...
<p:pipeline xmlns:p="http://www.orbeon.com/oxf/pipeline"
    ...
    <p:processor name="oxf:xslt">
        <p:input name="config"
            href="../xslt/checkExpressions.xsl"/>
