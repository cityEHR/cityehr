...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="filename" as="xs:string"
            select="if ($classId!='') then concat('../existSandBox/',$applicationId,'/ISO-13606/',$specialtyId,'-',$classId,'-13606.xml') else concat('../existSandBox/',$applicationId,'/ISO-13606/',$specialtyId,'-13606.xml')"/>
