    ...
    <xsl:template name="generateComposition">
        ...
        <!-- Document node - ClinicalDocument
            ...
            <xsl:if test="$compositionTypeIRI != '#CityEHR:View'">
                <ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
...
-->
                        ...
                        <component xmlns="urn:hl7-org:v3">
                            ...
                            <!-- Generate hidden sections for entries used in expressions (conditions, calculations or default values) 
