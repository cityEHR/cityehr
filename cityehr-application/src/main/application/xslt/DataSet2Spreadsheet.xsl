...
<xsl:stylesheet exclude-result-prefixes="xs" version="2.0"
    ...
    <xsl:variable name="parameters" select="document('input:parameters')/parameters/exportPipeline"/>
    
    <!-- Set the dictionary from the input document -->
